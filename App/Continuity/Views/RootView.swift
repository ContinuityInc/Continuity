...
///
/// On `main` this view also handles the continuity:// URL scheme, shared URLs, and clipboard
/// link detection; this branch has no remote import, so music enters only via Add Music →
/// Choose Audio Files.
struct RootView: View {
    ...
    var body: some View {
        NowPlayingView(mode: .home)
            // On launch: drop cached files orphaned by deletions, heal persisted tracks,
